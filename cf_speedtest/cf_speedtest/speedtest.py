...
import cf_speedtest.cf_speedtest.locations as locations
import cf_speedtest.cf_speedtest.options as options
...
def main(percentile=90, verify_ssl=None, output_file='speedTest.txt', patience=15, proxy=None) -> int:
    ...
    print(
        f"{percentile}{'th percentile results:':<24} Down: {d/1_000_000:.2f} Mbit/sec\t"
